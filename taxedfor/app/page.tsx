    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: "540px" }}>
        ...
        <div style={{ marginBottom: "1.25rem", fontSize: "0.8rem", letterSpacing: "0.05em" }}>
          <span style={{ color: "#666" }}>&gt; INPUT METHOD: </span>
          <button
            onClick={() => setInputMode("manual")}
            style={{
              background: inputMode === "manual" ? "#fff" : "#000",
              color: inputMode === "manual" ? "#000" : "#555",
              border: `1px solid ${inputMode === "manual" ? "#fff" : "#444"}`,
              fontFamily: "'JetBrains Mono', 'Courier New', monospace",
              fontSize: "0.78rem",
          ...
          <button
            ...
            style={{
              ...
              color: inputMode === "upload" ? "#000" : "#555",
              border: `1px solid ${inputMode === "upload" ? "#fff" : "#444"}`,
              fontFamily: "'JetBrains Mono', 'Courier New', monospace",
              fontSize: "0.78rem",
              padding: "0.2rem 0.7rem",
              cursor: "pointer",
        ...
        {inputMode === "manual" && (
          ...
          >
            {/* Header row */}
            <div style={{ borderBottom: "1px solid #333", padding: "0.6rem 1rem", color: "#888", fontSize: "0.78rem" }}>
              &gt; ENTER YOUR W-2 BOX NUMBERS
            </div>
            <div style={{ color: "#333", padding: "0 1rem", fontSize: "0.75rem", paddingTop: "0.3rem" }}>
              {'─'.repeat(55)}
            </div>
            ...
            <div style={{ padding: "0.5rem 1rem 1rem" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "4.5rem 1fr 7rem", gap: "0.5rem", alignItems: "center", padding: "0.35rem 0", borderBottom: "1px solid #111" }}>
                <span style={{ color: "#666", fontSize: "0.75rem" }}>Box 2</span>
                <span style={{ color: "#aaa", fontSize: "0.78rem" }}>Federal income tax withheld</span>
              ...
              {/* Box 4 */}
              <div style={{ display: "grid", gridTemplateColumns: "4.5rem 1fr 7rem", gap: "0.5rem", alignItems: "center", padding: "0.35rem 0", borderBottom: "1px solid #111" }}>
                <span style={{ color: "#666", fontSize: "0.75rem" }}>Box 4</span>
                <span style={{ color: "#aaa", fontSize: "0.78rem" }}>Social Security tax</span>
                <div style={{ display: "flex", alignItems: "center", gap: "0.2rem" }}>
                  <span style={{ color: "#555" }}>$</span>
                  <input
                    type="text"
              ...
              {/* Box 6 */}
              <div style={{ display: "grid", gridTemplateColumns: "4.5rem 1fr 7rem", gap: "0.5rem", alignItems: "center", padding: "0.35rem 0", borderBottom: "1px solid #111" }}>
                <span style={{ color: "#666", fontSize: "0.75rem" }}>Box 6</span>
                <span style={{ color: "#aaa", fontSize: "0.78rem" }}>Medicare tax</span>
                <div style={{ display: "flex", alignItems: "center", gap: "0.2rem" }}>
                  <span style={{ color: "#555" }}>$</span>
                  <input
                    type="text"
              ...
              {/* Box 16 */}
              <div style={{ display: "grid", gridTemplateColumns: "4.5rem 1fr 7rem", gap: "0.5rem", alignItems: "center", padding: "0.35rem 0", borderBottom: "1px solid #111" }}>
                <span style={{ color: "#666", fontSize: "0.75rem" }}>Box 16</span>
                <span style={{ color: "#aaa", fontSize: "0.78rem" }}>State wages</span>
                <div style={{ display: "flex", alignItems: "center", gap: "0.2rem" }}>
                  <span style={{ color: "#555" }}>$</span>
                  <input
                    type="text"
              ...
              {/* Box 17 */}
              <div style={{ display: "grid", gridTemplateColumns: "4.5rem 1fr 7rem", gap: "0.5rem", alignItems: "center", padding: "0.35rem 0", borderBottom: "1px solid #111" }}>
                <span style={{ color: "#666", fontSize: "0.75rem" }}>Box 17</span>
                <span style={{ color: "#aaa", fontSize: "0.78rem" }}>State income tax withheld</span>
                <div style={{ display: "flex", alignItems: "center", gap: "0.2rem" }}>
                  <span style={{ color: "#555" }}>$</span>
                  <input
                    type="text"
              ...
              <div style={{ display: "grid", gridTemplateColumns: "4.5rem 1fr 7rem", gap: "0.5rem", alignItems: "center", padding: "0.35rem 0" }}>
                <span style={{ color: "#666", fontSize: "0.75rem" }}>State</span>
                <span style={{ color: "#aaa", fontSize: "0.78rem" }}>e.g. AZ, CA, TX</span>
                <input
                  type="text"
                  maxLength={2}
                  value={stateCode}
            ...
            {/* Required note */}
            <div style={{ padding: "0 1rem 0.5rem", color: "#444", fontSize: "0.7rem" }}>
        ...
        {inputMode === "upload" && (
          <div>
            ...
            {/* Privacy note */}
            <div style={{ marginTop: "0.75rem", color: "#444", fontSize: "0.72rem", ...mono }}>
